...
CREATE TABLE IF NOT EXISTS `autocare`.`modelo_veiculo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_id_fabricante_idx` (`id_fabricante_veiculo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`veiculo` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_usuario_veiculo_idx` (`id_usuario` ASC) ,
  INDEX `fk_modelo_veiculo_idx` (`id_modelo_veiculo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`servico` (
  ...
  INDEX `fk_id_prestador_idx` (`id_prestador` ASC) ,
  INDEX `fk_id_veiculo_servico_idx` (`id_veiculo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`avaliacao` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_id_usuario_idx` (`id_usuario` ASC) ,
  INDEX `fk_id_servico_idx` (`id_servico` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`chat` (
  ...
  INDEX `fk_id_usuario_idx` (`id_usuario` ASC) ,
  INDEX `fk_id_prestador_idx` (`id_prestador` ASC) ,
  INDEX `fk_id_funcionario_idx` (`id_funcionario` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`especialidade` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_fabricante_veiculo_idx` (`id_fabricante_veiculo_especialidade` ASC) ,
  INDEX `fk_modelo_veiculo_idx` (`id_modelo_veiculo` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`localizacao` (
  ...
  `id_prestador` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_prestador_idx` (`id_prestador` ASC) ,
...
CREATE TABLE IF NOT EXISTS `autocare`.`mensagem` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_id_chat_idx` (`id_chat` ASC) ,
